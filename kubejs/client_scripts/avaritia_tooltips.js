onEvent('item.tooltip', tooltip => {
  tooltip.addAdvanced(Item.of('patchouli:guide_book', '{"patchouli:book":"patchouli:tome_of_finality"}'), (item, advanced, text) => {
    text.add(1, Text.of("§dHi! Please craft this book, it's important. - Overseers of Finality"))
  })
